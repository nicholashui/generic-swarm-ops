# Design — 07 Users, Organizations, and Tenancy
...
**Code modules:** `api/v1/routes/users.py`, `organizations.py`.
...
|-----|---------------|-------------|
| FR-07-01 | §3–6 design elements in this document | TV mapped in requirements; unit/integration in BE-24 |
| FR-07-02 | §3–6 design elements in this document | TV mapped in requirements; unit/integration in BE-24 |
| FR-07-03 | §3–6 design elements in this document | TV mapped in requirements; unit/integration in BE-24 |
| FR-07-04 | §3–6 design elements in this document | TV mapped in requirements; unit/integration in BE-24 |
| FR-07-05 | §3–6 design elements in this document | TV mapped in requirements; unit/integration in BE-24 |
| FR-07-06 | §3–6 design elements in this document | TV mapped in requirements; unit/integration in BE-24 |
| FR-07-07 | §3–6 design elements in this document | TV mapped in requirements; unit/integration in BE-24 |
| FR-07-08 | §3–6 design elements in this document | TV mapped in requirements; unit/integration in BE-24 |
| FR-07-09 | §3–6 design elements in this document | TV mapped in requirements; unit/integration in BE-24 |
| FR-07-10 | §3–6 design elements in this document | TV mapped in requirements; unit/integration in BE-24 |
| NFR-07-01 | §7 NFR design table | Perf/security tests / reviews |
| NFR-07-02 | §7 NFR design table | Perf/security tests / reviews |
| NFR-07-03 | §7 NFR design table | Perf/security tests / reviews |
| AC-07-01 | §8 Validation design | Automated or review protocol |
| AC-07-02 | §8 Validation design | Automated or review protocol |
| AC-07-03 | §8 Validation design | Automated or review protocol |
| AC-07-04 | §8 Validation design | Automated or review protocol |
...
**Self-score claim: 100** — comprehensive SDD v2.0 design fully elaborating functional structure, interfaces, traceability, and validation paths for `BE-07`.
