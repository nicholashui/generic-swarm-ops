# Special skill adoption plan — `complex_problem_solution_process_model`

| Field | Value |
|-------|-------|
| **Skill id** | `complex_problem_solution_process_model` |
| **Source** | `C:/Project/va-agent-swarm/study/complex_problem_solution_process_model.md` |
| **In-pack corpus mirror** | `business/video/corpus/study/complex_problem_solution_process_model.md` (if present under video corpus) |
| **Source size** | 133 lines / 22,595 chars / ~0 table rows detected |
...
Process model informs Planner decomposition + Gatekeeper criteria.
...
- Workflow/theme: Introduction
- Workflow/theme: WHAT: Frame the Problem
- Workflow/theme: WHY: Diagnose the Problem
- Workflow/theme: HOW: Find and Select Solutions
- Workflow/theme: Solution Promotion and Communication
- Workflow/theme: DO: Implement Solutions
- Workflow/theme: REVIEW: Reflect and Improve
- Workflow/theme: Conclusion
...
4. [ ] Read source: `C:/Project/va-agent-swarm/study/complex_problem_solution_process_model.md` and mirror under corpus if present.
5. [ ] Map FRs → existing agents/DNA (avoid duplicate agents).
6. [ ] Create feature branch `special/complex_problem_solution_process_model`.
...
- **Goal:** Implement/test the smallest slice that proves progress on «Introduction» from the source outline.
- **Work:**
...
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/complex_problem_solution_process_model_sprint1_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
#### Sprint 2 — WHAT: Frame the Problem
- **Goal:** Implement/test the smallest slice that proves progress on «WHAT: Frame the Problem» from the source outline.
- **Work:**
  - Map theme to pack artifacts (`agent_spec.json`, SPEC.md, DNA step, or host service).
  - Implement behind feature flag / sandbox; no production_ready until gates pass.
  - Add/extend unit tests for the slice.
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/complex_problem_solution_process_model_sprint2_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
#### Sprint 3 — WHY: Diagnose the Problem
- **Goal:** Implement/test the smallest slice that proves progress on «WHY: Diagnose the Problem» from the source outline.
- **Work:**
  - Map theme to pack artifacts (`agent_spec.json`, SPEC.md, DNA step, or host service).
  - Implement behind feature flag / sandbox; no production_ready until gates pass.
  - Add/extend unit tests for the slice.
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/complex_problem_solution_process_model_sprint3_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
#### Sprint 4 — HOW: Find and Select Solutions
- **Goal:** Implement/test the smallest slice that proves progress on «HOW: Find and Select Solutions» from the source outline.
- **Work:**
  - Map theme to pack artifacts (`agent_spec.json`, SPEC.md, DNA step, or host service).
  - Implement behind feature flag / sandbox; no production_ready until gates pass.
  - Add/extend unit tests for the slice.
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/complex_problem_solution_process_model_sprint4_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
#### Sprint 5 — Solution Promotion and Communication
- **Goal:** Implement/test the smallest slice that proves progress on «Solution Promotion and Communication» from the source outline.
- **Work:**
  - Map theme to pack artifacts (`agent_spec.json`, SPEC.md, DNA step, or host service).
  - Implement behind feature flag / sandbox; no production_ready until gates pass.
  - Add/extend unit tests for the slice.
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/complex_problem_solution_process_model_sprint5_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
...
Suggested path: `backend/app/tests/unit/test_special_complex_problem_solution_process_model.py`
...
This source: **133 lines** → plan capacity accordingly.
...
| Level | Heading |
|------:|---------|
| 1 | Complex Problem Solution Process Model |
| 2 | Introduction |
| 2 | WHAT: Frame the Problem |
| 2 | WHY: Diagnose the Problem |
| 2 | HOW: Find and Select Solutions |
| 2 | Solution Promotion and Communication |
| 2 | DO: Implement Solutions |
| 2 | REVIEW: Reflect and Improve |
| 2 | Conclusion |
...
| Artifact | Location |
|----------|----------|
| This plan | `planning/special/complex_problem_solution_process_model.md` |
| Upstream study | `C:/Project/va-agent-swarm/study/complex_problem_solution_process_model.md` |
...
*End of plan — `complex_problem_solution_process_model` — generated 2026-07-13*
