# Special skill adoption plan — `intent_analysis_agent`

| Field | Value |
|-------|-------|
| **Skill id** | `intent_analysis_agent` |
| **Source** | `C:/Project/va-agent-swarm/study/intent_analysis_agent_functional_specification.md` |
| **In-pack corpus mirror** | `business/video/corpus/study/intent_analysis_agent_functional_specification.md` (if present under video corpus) |
| **Source size** | 262 lines / 12,721 chars / ~0 table rows detected |
...
Feeds archetype_registry selection (recommend-workflow) + planner brief parse.
...
- Multi-Perspective Agent Simulation** (new): Spawn 4–6 parallel Grok agents, each embodying one POV (speaker, receiver, opponent, society, historical, environmental). Each produces angle summary + evidence. Aggregate with clustering.
...
4. [ ] Read source: `C:/Project/va-agent-swarm/study/intent_analysis_agent_functional_specification.md` and mirror under corpus if present.
5. [ ] Map FRs → existing agents/DNA (avoid duplicate agents).
6. [ ] Create feature branch `special/intent_analysis_agent`.
...
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/intent_analysis_agent_sprint1_notes.md` (optional) or this plan's risk log.
...
- **Work:**
  ...
  - Implement behind feature flag / sandbox; no production_ready until gates pass.
  - Add/extend unit tests for the slice.
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/intent_analysis_agent_sprint2_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
...
- **Work:**
  ...
  - Implement behind feature flag / sandbox; no production_ready until gates pass.
  - Add/extend unit tests for the slice.
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/intent_analysis_agent_sprint3_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
...
- **Work:**
  ...
  - Implement behind feature flag / sandbox; no production_ready until gates pass.
  - Add/extend unit tests for the slice.
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/intent_analysis_agent_sprint4_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
...
- **Work:**
  ...
  - Implement behind feature flag / sandbox; no production_ready until gates pass.
  - Add/extend unit tests for the slice.
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/intent_analysis_agent_sprint5_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
...
Suggested path: `backend/app/tests/unit/test_special_intent_analysis_agent.py`
...
This source: **262 lines** → plan capacity accordingly.
...
| 3 | 2. Background, Motivation & Research Foundation |
| 3 | 3. System Architecture (High-Level) |
| 3 | 4. Detailed Functional Requirements – 6 Phases (v2.0 Enhanced) |
| 3 | 5. Data Models & Output Schema (JSON) |
| 3 | 6. Non-Functional Requirements |
| 3 | 7. Implementation Roadmap |
| 3 | 8. Evaluation Framework |
| 3 | 9. Limitations & Future Work |
| 3 | 10. References (Key Sources) |
...
| Artifact | Location |
|----------|----------|
| This plan | `planning/special/intent_analysis_agent.md` |
| Upstream study | `C:/Project/va-agent-swarm/study/intent_analysis_agent_functional_specification.md` |
...
*End of plan — `intent_analysis_agent` — generated 2026-07-13*
