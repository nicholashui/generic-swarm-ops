# Special skill adoption plan — `general_creative_agent`

| Field | Value |
|-------|-------|
| **Skill id** | `general_creative_agent` |
| **Source** | `C:/Project/va-agent-swarm/study/general_creative_agent_functional_specification.md` |
| **In-pack corpus mirror** | `business/video/corpus/study/general_creative_agent_functional_specification.md` (if present under video corpus) |
| **Source size** | 196 lines / 13,480 chars / ~0 table rows detected |
...
Specialize via craft agents rather than one mega creative agent.
...
- Sparse Constraint** → “Sparse” (1–4 strategic outlier dimensions anchored in conventional core) per Uzzi et al. (2013) science-of-science findings.
- Reachability & Joint Novelty** → Combinations must be reachable in semantic graphs; joint (not marginal) outlier scoring.
- Final SSOR** → Fully operational, computable, and agent-implementable.
...
- Output & Model Update (persistent memory of successful patterns).
...
4. [ ] Read source: `C:/Project/va-agent-swarm/study/general_creative_agent_functional_specification.md` and mirror under corpus if present.
5. [ ] Map FRs → existing agents/DNA (avoid duplicate agents).
6. [ ] Create feature branch `special/general_creative_agent`.
...
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/general_creative_agent_sprint1_notes.md` (optional) or this plan's risk log.
...
- **Work:**
  ...
  - Implement behind feature flag / sandbox; no production_ready until gates pass.
  - Add/extend unit tests for the slice.
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/general_creative_agent_sprint2_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
...
- **Work:**
  ...
  - Implement behind feature flag / sandbox; no production_ready until gates pass.
  - Add/extend unit tests for the slice.
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/general_creative_agent_sprint3_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
...
- **Work:**
  ...
  - Implement behind feature flag / sandbox; no production_ready until gates pass.
  - Add/extend unit tests for the slice.
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/general_creative_agent_sprint4_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
...
- **Work:**
  ...
  - Implement behind feature flag / sandbox; no production_ready until gates pass.
  - Add/extend unit tests for the slice.
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/general_creative_agent_sprint5_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
...
Suggested path: `backend/app/tests/unit/test_special_general_creative_agent.py`
...
This source: **196 lines** → plan capacity accordingly.
...
| 3 | 2. Background: User’s Original Theory |
| 3 | 3. Evolution of the SSOR Model |
| 3 | 4. The Strategic Sparse Outlier Recombination (SSOR) Model – Formal Definition |
| 3 | 5. Research Foundation (Exhaustive Synthesis) |
| 3 | 6. AI-Native POVs Derived from NLAEs (Phase 1 Enhancement) |
| 3 | 7. Functional Requirements – General Creative Agent (GCA) |
| 3 | 8. Domain-Specific Creative Agent Factory |
| 3 | 9. Technical Architecture & Implementation Guidelines |
| 3 | 10. Evaluation & Success Criteria |
| 3 | 11. Full References (Curated & Expanded) |
...
| Artifact | Location |
|----------|----------|
| This plan | `planning/special/general_creative_agent.md` |
| Upstream study | `C:/Project/va-agent-swarm/study/general_creative_agent_functional_specification.md` |
...
*End of plan — `general_creative_agent` — generated 2026-07-13*
