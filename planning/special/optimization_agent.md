# Special skill adoption plan — `optimization_agent`

| Field | Value |
|-------|-------|
| **Skill id** | `optimization_agent` |
| **Source** | `C:/Project/va-agent-swarm/study/optimization_agent_functional_specification.md` |
| **In-pack corpus mirror** | `business/video/corpus/study/optimization_agent_functional_specification.md` (if present under video corpus) |
| **Source size** | 167 lines / 8,955 chars / ~6 table rows detected |
...
Optimization family already in roster 73–80; wire eval harness + lessons.
...
- Autonomous Scoping & Constraint Discovery**.
- Parallel Sub-Agent Execution** with user checkpoints.
...
4. [ ] Read source: `C:/Project/va-agent-swarm/study/optimization_agent_functional_specification.md` and mirror under corpus if present.
5. [ ] Map FRs → existing agents/DNA (avoid duplicate agents).
6. [ ] Create feature branch `special/optimization_agent`.
...
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/optimization_agent_sprint1_notes.md` (optional) or this plan's risk log.
...
- **Work:**
  ...
  - Implement behind feature flag / sandbox; no production_ready until gates pass.
  - Add/extend unit tests for the slice.
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/optimization_agent_sprint2_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
...
- **Work:**
  ...
  - Implement behind feature flag / sandbox; no production_ready until gates pass.
  - Add/extend unit tests for the slice.
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/optimization_agent_sprint3_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
...
- **Work:**
  ...
  - Implement behind feature flag / sandbox; no production_ready until gates pass.
  - Add/extend unit tests for the slice.
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/optimization_agent_sprint4_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
...
- **Work:**
  ...
  - Implement behind feature flag / sandbox; no production_ready until gates pass.
  - Add/extend unit tests for the slice.
- **Spec checkpoint:** Diff behavior vs source headings related to this theme; log gaps in `planning/special/optimization_agent_sprint5_notes.md` (optional) or this plan's risk log.
- **Exit:** Automated tests green + checklist of covered source requirements updated.
...
Suggested path: `backend/app/tests/unit/test_special_optimization_agent.py`
...
This source: **167 lines** → plan capacity accordingly.
...
| Level | Heading |
|------:|---------|
| 3 | 1. Executive Summary of Research & Key Upgrades |
| 3 | 2. Core Architecture (New – Multi-Agent Native) |
| 3 | 3. Updated Methodologies |
| 3 | 4. Enhanced Functional Requirements |
| 3 | 5. User Interaction Model (Agentic & Iterative) |
| 3 | 6. Input / Output Requirements (Unchanged but Expanded) |
| 3 | 7. Non-Functional Requirements (Major Upgrades) |
| 3 | 8. Success Criteria (Updated) |
| 3 | 9. Future Enhancements (v3.0+ Roadmap) |
...
| Artifact | Location |
|----------|----------|
| This plan | `planning/special/optimization_agent.md` |
| Upstream study | `C:/Project/va-agent-swarm/study/optimization_agent_functional_specification.md` |
...
*End of plan — `optimization_agent` — generated 2026-07-13*
