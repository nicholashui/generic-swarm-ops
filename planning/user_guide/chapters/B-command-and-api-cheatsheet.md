# Chapter B: Appendix B — Commands and API cheat sheet

> **Status:** PLAN SCAFFOLD — detailed outline for full prose in `book/user_guide/`  
> **Level:** Reference  
> **Part:** Appendices  
> **Est. time:** ref  
> **Final path:** `book/user_guide/chapters/B-command-and-api-cheatsheet.md`



## Learning objectives

- Copy-paste bootstrap, run, eval, and key API calls

## Narrative outline (to expand into full prose)

1. npm scripts table
2. Backend uvicorn and pytest
3. Frontend pnpm
4. Auth login curl
5. Recommend + special-skills curl
6. Improvement APIs
