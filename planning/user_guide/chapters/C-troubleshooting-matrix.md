# Chapter C: Appendix C — Troubleshooting matrix

> **Status:** PLAN SCAFFOLD — detailed outline for full prose in `book/user_guide/`  
> **Level:** Reference  
> **Part:** Appendices  
> **Est. time:** ref  
> **Final path:** `book/user_guide/chapters/C-troubleshooting-matrix.md`



## Learning objectives

- Jump from symptom to fix
...
2. ready degraded
3. Login fails
4. UI shows demo mocks
5. Domains missing from sidebar
6. Recommend empty / mock
7. Approval stuck
8. Inventory check fail
