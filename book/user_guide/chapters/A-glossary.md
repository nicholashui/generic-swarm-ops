# Chapter A: Appendix A — Glossary

> **Status:** PLAN SCAFFOLD — detailed outline for full prose in `book/user_guide/`  
> **Level:** Reference  
> **Part:** Appendices  
> **Est. time:** ref  
> **Final path:** `book/user_guide/chapters/A-glossary.md`
...
1. Agent, ALC, approval, archetype, audit, bootstrap
2. Canary, conformance, DNA, domain pack, demoMode
3. E1, evolution, federation, fitness, gate
4. Harness, inventory, K1-lite, lesson, loop DNA
5. Memory scopes, N1, PI, provenance, RBAC
6. Runtime, special skill, tool_effects, viral-hook

## Hands-on labs

_No lab (reference appendix)._
...
- 繁體中文：[`A-glossary_hk.md`](./A-glossary_hk.md)
