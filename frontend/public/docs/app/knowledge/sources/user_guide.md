...
1. Review source status and last sync times.
2. Open a source with elevated errorCount to diagnose ingestion.
3. Do not mark workflows production_ready if critical sources are failing.
...
- Spec: `/docs/app/knowledge/sources/spec.md`
