...
1. Open Workflows and locate the process you need (e.g. customer onboarding).
2. Open detail to review steps, gates, and fitness metrics.
3. Use Run now with a valid payload (flagship requires case_id).
4. Monitor the run under Workflow runs; approve human gates as required.
5. Create new DNA only with rollback and verification declared.
...
- Spec: `/docs/app/workflows/spec.md`
