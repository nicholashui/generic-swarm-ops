# User guide: Process intelligence

**Screen:** `/app/processes`  
**Who:** Operators with `processes:read` (or stronger)
...
1. Open Processes to see mined workflow models and bottlenecks.
2. Compare conformance gaps (SOP vs actual) before redesigning DNA.
3. Feed bottleneck insights into evolution hypotheses — still sandbox first.
...
- Spec: `/docs/app/processes/spec.md`
