...
**Screen:** `/app/settings/integrations`  
...
1. Verify integration health before critical workflow runs.
2. Rotate credentials via secure ops processes, not chat logs.
...
- Spec: `/docs/app/settings/integrations/spec.md`
