...
**Who:** Operators with `users:read` (or stronger)
...
1. Invite users with the minimum role required.
2. Disable accounts promptly on offboarding.
3. Share invite links securely; accept-invite sets session cookies via BFF.
...
- Spec: `/docs/app/settings/users/spec.md`
