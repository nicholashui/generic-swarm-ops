# User guide: Evaluations

**Screen:** `/app/evaluations`  
...
1. Review recent evaluation runs for regressions.
2. Open a run detail for score breakdown and failures.
3. Do not canary/promote variants with failed adversarial or golden suites.
...
- Spec: `/docs/app/evaluations/spec.md`
