# User guide: Evaluation run detail

**Screen:** `/app/evaluations/runs`  
**Who:** Operators with `evaluations:read` (or stronger)
...
1. Open from the evaluations list.
2. Note which suite failed (golden vs adversarial vs regression).
3. Link failures back to workflow DNA or prompts before re-running improve.
...
- Spec: `/docs/app/evaluations/runs/spec.md`
